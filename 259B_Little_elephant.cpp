...
int32_t main(){
    ...
    // given that the sum of each row and diagonal is same;
    int arr[3][3];
    for(int i=0;i<3;i++){
        for(int j=0;j<3;j++){
            cin>>arr[i][j];
    ...
    int y=(arr[0][1]+arr[0][2]+arr[2][0]+arr[2][1]-arr[1][0]-arr[1][2])/2;
    int z=(arr[1][0]+arr[1][2]-arr[2][0]-arr[2][1]+y);
    int x=arr[2][0]+arr[2][1]+z-arr[0][1]-arr[0][2];
    arr[0][0]=x;
    arr[1][1]=y;   
    arr[2][2]=z;
    for(int i=0;i<3;i++){
